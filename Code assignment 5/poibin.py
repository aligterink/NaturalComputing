# -*- coding: utf-8 -*-
"""
This code has been added as a dependency for different_chances.py. This is not my code, all credit goes to Mike Straka,
this code has only been included for easy reproducability of my results.
